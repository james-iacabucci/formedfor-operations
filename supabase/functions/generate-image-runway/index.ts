...
serve(async (req) => {
  ...
  try {
    ...
    const headers = {
      ...
      'x-api-version': '2024-01-01'  // Changed header name from X-Runway-Version to x-api-version
    }
    ...
    const runwayResponse = await fetch('https://api.runwayml.com/v2/text-to-image', {  // Changed from v1 to v2
      method: 'POST',
      headers,
