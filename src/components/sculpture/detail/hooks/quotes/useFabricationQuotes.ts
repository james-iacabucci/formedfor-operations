...
export function useFabricationQuotes(sculptureId: string, selectedVariantId: string | null) {
  ...
  const handleQuoteRequest = useCallback(async (fabricatorId: string, notes: string) => {
    ...
    const newQuote: NewQuote = {
      ...
      depth_in: variant.depth_in,
      weight_kg: variant.weight_kg,
      weight_lbs: variant.weight_lbs,
      base_material_id: variant.base_material_id,
      base_method_id: variant.base_method_id,
      base_height_in: variant.base_height_in,
      base_width_in: variant.base_width_in,
      base_depth_in: variant.base_depth_in,
      base_weight_kg: variant.base_weight_kg,
      base_weight_lbs: variant.base_weight_lbs,
